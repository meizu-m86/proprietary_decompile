...
_DWORD *__fastcall j_audio_route_init(int a1, int a2);
...
// int __cdecl pcm_close(_DWORD, _DWORD); weak
...
// void free(void *ptr);
// int __cdecl pcm_write(_DWORD, _DWORD); weak
...
int __fastcall j_pcm_data_dump(int a1, int a2, int a3, int a4);
...
signed int __fastcall sub_4424(struct hw_module_t *a1, const char *a2, audio_device **a3);
...
signed int __fastcall sub_5068(struct audio_device *a1, int a2, int a3, int a4, int a5, char **a6);
...
int sub_7320(); // weak
int sub_7324(); // weak
unsigned int __fastcall sub_7328(int a1);
signed int sub_733E();
unsigned int __fastcall sub_7344(int a1, void *a2, unsigned int a3);
signed int sub_7C90();
signed int sub_7C96();
...
_DWORD *__fastcall j_audio_route_init(int a1, int a2)
{
  return audio_route_init(a1, (const char *)a2);
}
...
int __fastcall j_pcm_data_dump(int a1, int a2, int a3, int a4)
{
  return pcm_data_dump((const char *)a1, a2, a3, a4);
}
...
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_7:
  ...
  v10 = j_audio_route_init(0, (int)"/system/etc/mixer_paths.xml");
  *(_DWORD *)(v1 + 188) = v10;
  if ( !v10 )
  ...
  if ( v11 && !pcm_is_ready() )
  {
    v15 = pcm_get_error(v11);
    _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(BACKEND) failed: %s", "amplifier_initialize", v15);
    v13 = 0;
  }
  else
  {
    ...
    if ( v12 && !pcm_is_ready() )
    {
      v17 = pcm_get_error(v12);
      _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(AMPLIFIER) failed: %s", "amplifier_initialize", v17);
      v13 = 0;
    }
    else
    {
...
// 30B0: using guessed type int __cdecl pcm_close(_DWORD, _DWORD);
...
signed int __fastcall wav_player_start(const char *a1, int a2, int a3)
{
  ...
  int v48; // r1@42
  int *v49; // r5@42
  int v50; // [sp+0h] [bp-90h]@6
  unsigned int v51; // [sp+Ch] [bp-84h]@21
  int v52; // [sp+Ch] [bp-84h]@27
  unsigned int v53; // [sp+10h] [bp-80h]@21
  unsigned int size; // [sp+14h] [bp-7Ch]@13
  int sizea; // [sp+14h] [bp-7Ch]@27
  void *ptr; // [sp+18h] [bp-78h]@26
  char v57; // [sp+1Ch] [bp-74h]@9
  unsigned __int16 v58; // [sp+1Eh] [bp-72h]@13
  unsigned int v59; // [sp+20h] [bp-70h]@13
  unsigned __int16 v60; // [sp+2Ah] [bp-66h]@13
  int v61; // [sp+2Ch] [bp-64h]@6
  __int32 off; // [sp+30h] [bp-60h]@8
  int v63; // [sp+34h] [bp-5Ch]@2
  int v64; // [sp+3Ch] [bp-54h]@3
  int v65; // [sp+40h] [bp-50h]@13
  int v66; // [sp+44h] [bp-4Ch]@13
  int v67; // [sp+48h] [bp-48h]@13
  int v68; // [sp+4Ch] [bp-44h]@13
  int v69; // [sp+50h] [bp-40h]@17
  int v70; // [sp+54h] [bp-3Ch]@20
  int v71; // [sp+58h] [bp-38h]@20
  int v72; // [sp+5Ch] [bp-34h]@20
  int v73; // [sp+68h] [bp-28h]@1
  ...
  _fread_chk(&v63, 12, 1, v6);
  if ( v63 != 1179011410 || v64 != 1163280727 )
  {
  ...
  {
    v50 = 8;
    _fread_chk(&v61, 8, 1, v6);
    if ( v61 != 544501094 )
      break;
    _fread_chk(&v57, 16, 1, v6);
...
LABEL_41:
    _android_log_print(6, v46, v47, v13, v50);
    goto LABEL_46;
  }
  ...
  if ( !(v17 & v18 & v19 & v20 & v21) )
    goto LABEL_46;
  v22 = 0;
  dword_116D0 = pcm_open(v4, v13, 0, &v65);
  if ( !dword_116D0 )
  {
LABEL_40:
    v50 = pcm_get_error(v22);
    v46 = "audio_hw_primary";
...
LABEL_47:
  if ( _stack_chk_guard != v73 )
    _stack_chk_fail(result, _stack_chk_guard - v73);
  return result;
}
// 2FC0: using guessed type int __fastcall _errno(_DWORD);
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
...
// 3134: using guessed type int __cdecl pcm_write(_DWORD, _DWORD);
// 116C8: using guessed type int dword_116C8;
// 116CC: using guessed type int dword_116CC;
...
int is_headphone_on()
{
  ...
  if ( _stack_chk_guard != v3 )
    _stack_chk_fail(result, _stack_chk_guard - v3);
  return result;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
// 30C8: using guessed type int __fastcall _fread_chk(_DWORD, _DWORD, _DWORD, _DWORD);
...
LABEL_11:
  ...
  if ( _stack_chk_guard != v13 )
    _stack_chk_fail(result, _stack_chk_guard - v13);
  return result;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
signed int __fastcall sub_4424(struct hw_module_t *a1, const char *a2, audio_device **a3)
{
  struct hw_module_t *v3; // r6@1
  audio_device **v4; // r5@1
  signed int result; // r0@2
  audio_device *v6; // r4@3
  struct audio_route *v7; // r0@4
  struct audio_device::mixer *v8; // r0@5
  struct audio_device::mixer *v9; // r0@6
  int v10; // r0@9
  ...
  v6->hw_device.common.module = v3;
  v6->hw_device.common.close = (int (__cdecl *)(struct hw_device_t *))sub_46E0;
  v6->hw_device.init_check = (int (__cdecl *)(const struct audio_hw_device *))sub_470A;
  v6->hw_device.set_voice_volume = (int (__cdecl *)(struct audio_hw_device *, float))sub_4710;
  v6->hw_device.set_master_volume = (int (__cdecl *)(struct audio_hw_device *, float))sub_4824;
  v6->hw_device.set_mode = (int (__cdecl *)(struct audio_hw_device *, audio_mode_t))sub_482C;
  v6->hw_device.set_mic_mute = (int (__cdecl *)(struct audio_hw_device *, bool))sub_4B34;
  v6->hw_device.get_mic_mute = (int (__cdecl *)(const struct audio_hw_device *, bool *))sub_4B3C;
  v6->hw_device.set_parameters = (int (__cdecl *)(struct audio_hw_device *, const char *))sub_4B48;
  v6->hw_device.get_parameters = (char *(__cdecl *)(const struct audio_hw_device *, const char *))sub_4E6C;
  v6->hw_device.get_input_buffer_size = (size_t (__cdecl *)(const struct audio_hw_device *, const struct audio_hw_device::audio_config *))sub_4FD0;
  v6->hw_device.open_output_stream = (int (__cdecl *)(struct audio_hw_device *, audio_io_handle_t, audio_devices_t, audio_output_flags_t, struct audio_hw_device::audio_config *, struct audio_stream_out **, const char *))sub_5068;
  v6->hw_device.close_output_stream = (void (__cdecl *)(struct audio_hw_device *, struct audio_stream_out *))sub_52B8;
  v6->hw_device.open_input_stream = (int (__cdecl *)(struct audio_hw_device *, audio_io_handle_t, audio_devices_t, struct audio_hw_device::audio_config *, struct audio_stream_in **, audio_input_flags_t, const char *, audio_source_t))sub_52F4;
  v6->hw_device.close_input_stream = (void (__cdecl *)(struct audio_hw_device *, struct audio_stream_in *))sub_5520;
  v6->hw_device.dump = (int (__cdecl *)(const struct audio_hw_device *, int))sub_55A0;
  v6->hw_device.set_headphone_volume = (int (__cdecl *)(struct audio_hw_device *, float))adev_set_headset_volume;
  v6->hw_device.dumb2 = (int *)sub_55A4;
  v7 = (struct audio_route *)j_audio_route_init(0, (int)"/system/etc/mixer_paths.xml");
  v6->audio_route = v7;
  if ( !v7 )
  {
...
LABEL_16:
  ...
  v8 = (struct audio_device::mixer *)mixer_open(0);
  v6->mixer = v8;
  if ( !v8 )
  {
    _android_log_print(6, "audio_hw_primary", "%s(): failed to open mixer, abort...", "adev_open");
LABEL_14:
    j_audio_route_free((int)v6->audio_route);
    goto LABEL_15;
  }
  v9 = (struct audio_device::mixer *)mixer_open(1);
  v6->hifi_mixer = v9;
  if ( !v9 )
  {
  ...
  *(_QWORD *)&v6->hifi_gain_state = -4294967296LL;
...
int __fastcall sub_4710(int a1, int a2)
{
  ...
  if ( _stack_chk_guard != v14 )
    _stack_chk_fail(_stack_chk_guard - v14, v14);
  return 0;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
  ...
  *(_DWORD *)(v2 + 168) = v3;
  ...
  if ( !v4 )
  {
    ...
    *(_DWORD *)(v2 + 200) = 4;
    ...
    {
      v12 = 0;
      v13 = pcm_open(0, 3, 0, &pcm_config_voice_call);
      *(_DWORD *)(v2 + 220) = v13;
      if ( v13 )
      {
        v14 = pcm_is_ready();
        ...
        if ( !v14 )
        {
          v18 = pcm_get_error(*(_DWORD *)(v2 + 220));
          _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(VOICE_OUT) failed: %s", "start_call", v18);
          goto LABEL_27;
        }
      }
      pcm_prepare(v12);
...
LABEL_28:
    ...
    v15 = 0;
    v16 = pcm_open(0, 3, 0x10000000, &pcm_config_voice_call);
    *(_DWORD *)(v2 + 224) = v16;
    if ( !v16 || (v17 = pcm_is_ready(), v15 = *(_DWORD *)(v2 + 224), v17) )
    {
      pcm_prepare(v15);
      goto LABEL_28;
    }
    v20 = pcm_get_error(*(_DWORD *)(v2 + 224));
    _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(VOICE_IN) failed: %s", "start_call", v20);
    pcm_close(*(_DWORD *)(v2 + 224), v21);
    *(_DWORD *)(v2 + 224) = 0;
LABEL_27:
    pcm_close(*(_DWORD *)(v2 + 220), v19);
    *(_DWORD *)(v2 + 220) = 0;
    goto LABEL_28;
  }
LABEL_29:
...
int __fastcall sub_4B48(int a1, int a2)
{
  ...
  if ( _stack_chk_guard != v16 )
    _stack_chk_fail(_stack_chk_guard - v16, v16);
  return v11;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_12:
  if ( _stack_chk_guard != v18 )
    _stack_chk_fail(_stack_chk_guard - v18, v18);
  return v6;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
signed int __fastcall sub_5068(struct audio_device *a1, int a2, int a3, int a4, int a5, char **a6)
{
  ...
  *((_DWORD *)v16 + 3) = v19;
  *((_DWORD *)v16 + 4) = v20;
  v9->stream.common.get_sample_rate = (uint32_t (__cdecl *)(const struct audio_stream *))sub_6E08;
  v9->stream.common.set_sample_rate = (int (__cdecl *)(struct audio_stream *, uint32_t))sub_6E0E;
  v9->stream.common.get_buffer_size = (size_t (__cdecl *)(const struct audio_stream *))sub_6E16;
  v9->stream.common.get_channels = (audio_channel_mask_t (__cdecl *)(const struct audio_stream *))sub_6E22;
  v9->stream.common.get_format = (audio_format_t (__cdecl *)(const struct audio_stream *))sub_6E28;
  v9->stream.common.set_format = (int (__cdecl *)(struct audio_stream *, audio_format_t))sub_6E2E;
  v9->stream.common.standby = (int (__cdecl *)(struct audio_stream *))sub_6644;
  v9->stream.common.dump = (int (__cdecl *)(const struct audio_stream *, int))sub_6E34;
  v9->stream.common.set_parameters = (int (__cdecl *)(struct audio_stream *, const char *))sub_6E38;
  v9->stream.common.get_parameters = (char *(__cdecl *)(const struct audio_stream *, const char *))sub_723C;
  v9->stream.common.add_audio_effect = (int (__cdecl *)(const struct audio_stream *, effect_handle_t))sub_7320;
  v9->stream.common.remove_audio_effect = (int (__cdecl *)(const struct audio_stream *, effect_handle_t))sub_7324;
  v9->stream.get_latency = (uint32_t (__cdecl *)(const struct audio_stream_out *))sub_7328;
  v9->stream.set_volume = (int (__cdecl *)(struct audio_stream_out *, float, float))sub_733E;
  v9->stream.write = (ssize_t (__cdecl *)(struct audio_stream_out *, const void *, size_t))sub_7344;
  v9->stream.get_render_position = (int (__cdecl *)(const struct audio_stream_out *, uint32_t *))sub_7C90;
  v9->stream.get_next_write_timestamp = (int (__cdecl *)(const struct audio_stream_out *, int64_t *))sub_7C96;
  v9->stream.get_presentation_position = (int (__cdecl *)(const struct audio_stream_out *, uint64_t *, struct timespec *))sub_7C9C;
  v9->adev = v6;
  ...
  v22 = v21;
  v10->v_192 = (void *)v21;
  v23 = ((int (__fastcall *)(stream_out *))v10->stream.common.get_format)(v10);
...
LABEL_12:
    ...
    v26 = ((int (__fastcall *)(stream_out *))v10->stream.common.get_channels)(v10);
    if ( 2 == v26 >> 30 )
    {
      v27 = v26 & 0x3FFFFFFF;
    }
...
LABEL_22:
  ...
  v10->v_124 = (void *)(v22 / v8);
  *(_DWORD *)(a5 + 8) = v10->in_format;
  *(_DWORD *)(a5 + 4) = v10->channel_mask;
  *(_DWORD *)a5 = v10->in_sample_rate;
  LOBYTE(v10->v_160) = 1;
  ...
  {
    v6->stream_out = (struct audio_stream_out **)v10;
    v6->output_stream_state = 1;
    pthread_mutex_unlock(&v6->lock);
    result = 0;
    *a6 = (char *)v10;
  }
...
LABEL_12:
  if ( _stack_chk_guard != v15 )
    _stack_chk_fail(result, _stack_chk_guard - v15);
  return result;
}
// 2F6C: using guessed type int __fastcall property_get(_DWORD, _DWORD, _DWORD);
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
...
int __fastcall sub_5730(int a1)
{
  ...
  int v50; // r0@104
  int v51; // r1@104
  const char *v52; // r5@108
  const char *v53; // r7@108
  signed int v54; // r0@111
  int v55; // r0@112
  signed int v56; // r1@112
  const char *v57; // r0@121
  const char *v58; // r3@121
  int v59; // r5@135
  signed int v60; // r2@137
  signed int v61; // r0@137
  int result; // r0@150
  int v63; // r0@153
  int v64; // r1@153
  int v65; // r0@154
  int v66; // r0@154
  int v67; // r0@156
  int v68; // [sp+10h] [bp-B0h]@1
  int v69; // [sp+14h] [bp-ACh]@17
  char s1[4]; // [sp+18h] [bp-A8h]@5
  int v71; // [sp+1Ch] [bp-A4h]@29
  int v72; // [sp+20h] [bp-A0h]@29
  int v73; // [sp+24h] [bp-9Ch]@29
  int v74; // [sp+28h] [bp-98h]@29
  int v75; // [sp+2Ch] [bp-94h]@29
  int v76; // [sp+30h] [bp-90h]@29
  int v77; // [sp+34h] [bp-8Ch]@29
  int v78; // [sp+38h] [bp-88h]@29
  int v79; // [sp+3Ch] [bp-84h]@29
  int v80; // [sp+98h] [bp-28h]@1
...
LABEL_54:
  if ( !*(_DWORD *)(v1 + 228) || !*(_DWORD *)(v1 + 232) || byte_116D4 != 1 || v14 != dword_116D8 || v74 != dword_116DC )
  {
    _android_log_print(
      3,
      "audio_hw_primary",
    ...
    v22 = pcm_open(0, 2, 0, s1);
    *(_DWORD *)(v1 + 228) = v22;
    if ( v22 && !pcm_is_ready() )
    {
      v24 = pcm_get_error(*(_DWORD *)(v1 + 228));
      _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(BACKEND_OUT) failed: %s", "start_backend", v24);
    }
    else
    {
      v23 = pcm_open(0, 2, 0x10000000, s1);
      *(_DWORD *)(v1 + 232) = v23;
      if ( !v23 || pcm_is_ready() )
      {
      ...
      v26 = pcm_get_error(*(_DWORD *)(v1 + 232));
      _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(BACKEND_IN) failed: %s", "start_backend", v26);
      v27 = *(_DWORD *)(v1 + 232);
      if ( v27 )
      {
        pcm_close(v27, v25);
...
LABEL_89:
    ...
    v35 = 0;
    v36 = pcm_open(0, 6, 0x10000000, s1);
    *(_DWORD *)(v1 + 248) = v36;
    if ( !v36 || (v37 = pcm_is_ready(), v35 = *(_DWORD *)(v1 + 248), v37) )
    {
      pcm_prepare(v35);
      goto LABEL_89;
    }
    v65 = pcm_get_error(*(_DWORD *)(v1 + 248));
    _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(PA_IN) failed: %s", "pre_start_amplifier", v65);
    v66 = *(_DWORD *)(v1 + 248);
    if ( v66 )
    {
      pcm_close(v66, v64);
  ...
  v32 = 0;
  v33 = pcm_open(0, 6, 0, s1);
  *(_DWORD *)(v1 + 244) = v33;
  if ( !v33 || (v34 = pcm_is_ready(), v32 = *(_DWORD *)(v1 + 244), v34) )
  {
    pcm_prepare(v32);
    goto LABEL_85;
  }
  v63 = pcm_get_error(*(_DWORD *)(v1 + 244));
  _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(PA_OUT) failed: %s", "pre_start_amplifier", v63);
LABEL_156:
  v67 = *(_DWORD *)(v1 + 244);
  if ( v67 )
  {
...
LABEL_90:
  ...
  if ( v5 == 1 )
  {
    if ( !v38 )
    {
      ...
      v39 = 0;
      v40 = pcm_open(0, 5, 0, &pcm_config_sco);
      *(_DWORD *)(v1 + 236) = v40;
      if ( v40 )
      {
        v41 = pcm_is_ready();
        ...
        if ( !v41 )
        {
          v48 = pcm_get_error(*(_DWORD *)(v1 + 236));
          _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(SCO_OUT) failed: %s", "start_bt_sco", v48);
LABEL_105:
          pcm_close(*(_DWORD *)(v1 + 236), v49);
          *(_DWORD *)(v1 + 236) = 0;
          goto LABEL_106;
        }
      }
    ...
    if ( *(_DWORD *)(v1 + 240) )
      goto LABEL_106;
    v42 = 0;
    v43 = pcm_open(0, 5, 0x10000000, &pcm_config_sco);
    *(_DWORD *)(v1 + 240) = v43;
    if ( !v43 || (v44 = pcm_is_ready(), v42 = *(_DWORD *)(v1 + 240), v44) )
    {
      pcm_prepare(v42);
      goto LABEL_106;
    }
    v50 = pcm_get_error(*(_DWORD *)(v1 + 240));
    _android_log_print(6, "audio_hw_primary", "%s(): pcm_open(SCO_IN) failed: %s", "start_bt_sco", v50);
    pcm_close(*(_DWORD *)(v1 + 240), v51);
    *(_DWORD *)(v1 + 240) = 0;
    goto LABEL_105;
  }
  if ( v38 )
...
LABEL_106:
  ...
  else if ( v2 == 8 )
  {
    ...
    if ( v55 == -2147483632 )
      v56 = 1;
    v53 = 0;
    v52 = (**(&off_10AC4 + 7 * v3 + v56))[1];
  }
  else
  {
    v52 = (const char *)(*(_QWORD *)*(&off_10AC4 + 7 * v3 + v2) >> 32);
    v53 = (const char *)*(_QWORD *)*(&off_10AC4 + 7 * v3 + v2);
  }
  v57 = "none";
  v58 = "none";
  if ( v52 )
  ...
  _android_log_print(
    ...
    *(_DWORD *)(v1 + 200),
    ...
    v58);
  if ( v53 )
    j_audio_route_apply_path(*(_DWORD *)(v1 + 188), v53);
  if ( v52 )
    j_audio_route_apply_path(*(_DWORD *)(v1 + 188), v52);
  ...
  if ( v69 && !*(_DWORD *)(v1 + 168) && !*(_BYTE *)(v1 + 289) )
    usleep(0x4E20u);
  if ( !v11 )
  {
    if ( !*(_BYTE *)(v1 + 260) )
...
LABEL_145:
  ...
  if ( v68 || v59 == 2 )
  {
    ...
    if ( v59 == 2 )
      v60 = 1;
    if ( NxpTfa98xx_PowerOn(v61 | v60, *(_DWORD *)(v1 + 264), 0) )
...
LABEL_150:
  result = _stack_chk_guard - v80;
  if ( _stack_chk_guard != v80 )
    _stack_chk_fail(result, v80);
  return result;
}
// 2F6C: using guessed type int __fastcall property_get(_DWORD, _DWORD, _DWORD);
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
...
int __fastcall sub_66B0(int a1, int a2)
{
  ...
  int v32; // r1@43
  int v33; // r0@44
  const char *v34; // r1@46
  const char *v35; // r2@46
  const char *v36; // r3@46
  int v37; // r0@47
  int v38; // r1@47
  int v39; // r0@48
  int v40; // r1@48
  ...
  char v44; // [sp+8h] [bp-70h]@24
  int v45; // [sp+28h] [bp-50h]@24
  int v46; // [sp+2Ch] [bp-4Ch]@24
  char s1; // [sp+30h] [bp-48h]@1
  int v48; // [sp+50h] [bp-28h]@1
  ...
  if ( strcmp(&s1, "pa_calibration") )
  {
    if ( strcmp(&s1, "modem_loopback") )
    {
      if ( !strcmp(&s1, "off") )
      {
        ...
        v42 = pthread_mutex_lock((pthread_mutex_t *)(v2 + 164));
        NxpTfa98xx_PowerOff(v42);
        sub_6CBC(v2);
        v5 = 0;
...
LABEL_53:
  ...
  v21 = pcm_open(0, 2, 0x10000000, &v44);
  *(_DWORD *)(v2 + 232) = v21;
  if ( v21 && !pcm_is_ready() )
  {
...
LABEL_52:
    pcm_close(*(_DWORD *)(v2 + 228), v28);
    *(_DWORD *)(v2 + 228) = 0;
    goto LABEL_53;
  }
  v22 = pcm_open(0, 3, 0, &v44);
  *(_DWORD *)(v2 + 220) = v22;
  if ( v22 && !pcm_is_ready() )
  {
    v29 = pcm_get_error(*(_DWORD *)(v2 + 220));
    _android_log_print(6, "audio_hw_primary", "pcm_open(VOICE_OUT) failed: %s", v29);
LABEL_51:
    pcm_close(*(_DWORD *)(v2 + 232), v30);
    *(_DWORD *)(v2 + 232) = 0;
    goto LABEL_52;
  }
  v23 = pcm_open(0, 3, 0x10000000, &v44);
  *(_DWORD *)(v2 + 224) = v23;
  if ( v23 && !pcm_is_ready() )
  {
    v31 = pcm_get_error(*(_DWORD *)(v2 + 224));
    _android_log_print(6, "audio_hw_primary", "pcm_open(VOICE_IN) failed: %s", v31);
LABEL_50:
    pcm_close(*(_DWORD *)(v2 + 220), v32);
    *(_DWORD *)(v2 + 220) = 0;
    goto LABEL_51;
  }
  v24 = pcm_open(0, 6, 0, &v44);
  *(_DWORD *)(v2 + 244) = v24;
  if ( v24 && !pcm_is_ready() )
  {
    v37 = pcm_get_error(*(_DWORD *)(v2 + 244));
    _android_log_print(6, "audio_hw_primary", "pcm_open(PA_OUT) failed: %s", v37);
LABEL_49:
    pcm_close(*(_DWORD *)(v2 + 224), v38);
    *(_DWORD *)(v2 + 224) = 0;
    goto LABEL_50;
  }
  v25 = pcm_open(0, 6, 0x10000000, &v44);
  *(_DWORD *)(v2 + 248) = v25;
  if ( v25 && !pcm_is_ready() )
  {
    v39 = pcm_get_error(*(_DWORD *)(v2 + 248));
    _android_log_print(6, "audio_hw_primary", "pcm_open(PA_IN) failed: %s", v39);
    pcm_close(*(_DWORD *)(v2 + 244), v40);
    *(_DWORD *)(v2 + 244) = 0;
    goto LABEL_49;
  }
  ...
  if ( v11 != 1 )
  {
    v33 = sub_6D54(*(_DWORD *)(v2 + 192), v10, 1);
    if ( v9 == 1 )
    {
      if ( NxpTfa98xx_PowerOn(0, 48000, 0) )
      {
        v34 = "audio_hw_primary";
        v35 = "%s(): failed to power on tfa98xx";
        v36 = "audio_test";
LABEL_59:
        _android_log_print(6, v34, v35, v36);
        goto LABEL_60;
      }
    }
    else if ( NxpTfa98xx_PowerOff(v33) )
    {
      v34 = "audio_hw_primary";
      v35 = "%s(): failed to power off tfa98xx";
      v36 = "audio_test";
      goto LABEL_59;
    }
LABEL_60:
...
LABEL_54:
  if ( _stack_chk_guard != v48 )
    _stack_chk_fail(_stack_chk_guard - v48, v48);
  return v5;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_58:
  ...
  if ( _stack_chk_guard != v34 )
    _stack_chk_fail(_stack_chk_guard - v34, v34);
  return 0;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
unsigned int __fastcall sub_7328(int a1)
{
  return (unsigned int)(1000 * (*(_QWORD *)(a1 + 124) >> 32) * *(_QWORD *)(a1 + 124)) / *(_DWORD *)(a1 + 184);
}
...
unsigned int __fastcall sub_7344(int a1, void *a2, unsigned int a3)
{
  ...
  char *v15; // r6@20
  struct audio_device *v16; // r4@20
  int v21; // r10@20
  void *v22; // r5@20
  audio_mode_t v23; // r0@20
  int v24; // r0@23
  char *v25; // r1@24
  char *v26; // r2@24
  audio_devices_t v27; // r0@28
  signed int v28; // r2@28
  signed int v29; // r10@28
  bool v30; // zf@28
  signed int v31; // r0@32
  audio_format_t v32; // r1@32
  audio_format_t v33; // r1@33
  ...
  void *v50; // r5@67
  void *v51; // r6@67
  audio_format_t v52; // r7@67
  void *v53; // r3@67
  void *v54; // r5@67
  void *v55; // r6@67
  void *v56; // r7@67
  struct stream_out::pcm *v57; // r5@68
  struct stream_out::pcm *v58; // r0@68
  char *v59; // r7@69
  int v60; // r0@69
  int v61; // r4@71
  audio_format_t v62; // r0@73
  signed int v63; // r1@74
  void *v64; // r0@75
  int v65; // r2@76
  void *v66; // r3@76
  void *v67; // r6@76
  audio_format_t v68; // r7@76
  void *v69; // r2@76
  void *v70; // r3@76
  void *v71; // r6@76
  void *v72; // r7@76
  struct stream_out::pcm *v73; // r5@77
  struct stream_out::pcm *v74; // r0@77
  int v75; // r0@78
  struct stream_out::pcm *v76; // r0@81
  int v77; // r0@85
  void *v78; // r0@86
  int v79; // r1@86
  int v80; // r0@89
  ...
  int v82; // r0@90
  int v83; // r0@91
  struct stream_out::pcm *v84; // r0@92
  struct stream_out::pcm *v85; // r0@94
  audio_format_t v86; // r1@102
  char v87; // r0@104
  int v88; // r2@107
  int v89; // r3@113
  unsigned int v90; // r7@114
  char v91; // r5@114
  char v92; // r7@114
  char *v93; // r6@114
  struct resampler_itfe **v94; // r0@119
  void *v95; // r3@123
  int v96; // r0@123
  stream_out *v97; // r7@127
  _WORD *v98; // r9@127
  int v99; // r11@127
  int v100; // r5@127
  int v101; // r8@127
  int v102; // r0@128
  int v103; // r0@130
  audio_format_t v104; // r2@131
  signed int v105; // r1@132
  int v106; // r0@141
  bool v107; // zf@141
  signed int v108; // r5@146
  int v109; // r0@144
  unsigned int v110; // r0@152
  unsigned int v111; // r0@154
  unsigned int v112; // r0@156
  unsigned int v113; // r0@156
  unsigned int v115; // [sp+18h] [bp-70h]@20
  char *v116; // [sp+1Ch] [bp-6Ch]@67
  int v117; // [sp+20h] [bp-68h]@51
  pthread_mutex_t *mutex; // [sp+28h] [bp-60h]@19
  unsigned int v119; // [sp+2Ch] [bp-5Ch]@1
  unsigned int v120; // [sp+30h] [bp-58h]@19
  unsigned int v121; // [sp+34h] [bp-54h]@19
  char v122; // [sp+38h] [bp-50h]@20
  int v123; // [sp+3Ch] [bp-4Ch]@76
  signed int v124; // [sp+40h] [bp-48h]@67
  void *v125; // [sp+44h] [bp-44h]@76
  audio_format_t v126; // [sp+48h] [bp-40h]@76
  void *v127; // [sp+4Ch] [bp-3Ch]@76
  void *v128; // [sp+50h] [bp-38h]@76
  void *v129; // [sp+54h] [bp-34h]@76
  void *v130; // [sp+58h] [bp-30h]@20
  void *v131; // [sp+5Ch] [bp-2Ch]@20
  int v132; // [sp+60h] [bp-28h]@1

  v3 = (stream_out *)a1;
  v119 = a3;
  v4 = a2;
  v132 = _stack_chk_guard;
  v5 = *(audio_device **)(a1 + 204);
  v6 = (*(int (**)(void))(a1 + 16))();
...
LABEL_8:
  ...
  v10 = ((int (__fastcall *)(stream_out *))v3->stream.common.get_channels)(v3);
  if ( 2 == v10 >> 30 )
  {
    v11 = v10 & 0x3FFFFFFF;
  }
...
LABEL_19:
  v14 = &v5->lock;
  v121 = v119 / v9;
  v120 = 4 * dword_11010 * unk_11014 / v9;
  ...
  v130 = 0;
  v131 = 0;
  v16->stream_out = (struct audio_stream_out **)v3;
  _android_log_print(
    3,
    "audio_hw_primary",
...
LABEL_42:
  if ( v22 && !v21 )
  {
    ...
    if ( !v35 )
    {
      v3->sample_rate = dword_11034;
      v3->format = 0;
    }
  }
  v36 = (unsigned int)v3->v_192;
  v37 = ((int (__fastcall *)(stream_out *))v3->stream.common.get_format)(v3);
...
LABEL_55:
    ...
    v117 = (int)v16;
    v43 = ((int (__fastcall *)(stream_out *))v3->stream.common.get_channels)(v3);
    if ( 2 == v43 >> 30 )
    {
      v44 = v43 & 0x3FFFFFFF;
      v42 = v34;
...
LABEL_67:
  ...
  v3->v_124 = (void *)v47;
  v116 = (char *)&v3->v_116;
  v3->v_136 = (void *)((unsigned int)v3->v_128 * v47);
  v48 = v15;
  v49 = v3->sample_rate;
  v50 = v3->v_124;
  v51 = v3->v_128;
  ...
  *((_DWORD *)v48 + 4) = v56;
  ...
  if ( v42 == 1 )
  {
    ...
    _android_log_print(
      ...
      v3->format,
      4096);
    v58 = (struct stream_out::pcm *)pcm_open(0, v3->devices, 8, &v122);
    v3->pcm = v58;
    if ( v58 )
    {
      v59 = (char *)&v3->pcm;
...
LABEL_96:
    ...
    _android_log_print(
      ...
      v62,
      v63);
    v74 = (struct stream_out::pcm *)pcm_open(1, 0, 8, &v122);
    v3->hifi_pcm = v74;
    if ( v74 )
    {
      v75 = pcm_is_ready();
...
LABEL_94:
  ...
  if ( *(_BYTE *)(v117 + 173) & 0x10 )
  {
    _android_log_print(
      ...
      v3->devices,
      v3->sample_rate);
    v76 = (struct stream_out::pcm *)pcm_open(2, v3->devices, 8, v116);
    v3->spdif_pcm = v76;
    if ( v76 )
    {
      if ( !pcm_is_ready() )
      {
        v83 = pcm_get_error(v3->spdif_pcm);
        _android_log_print(
          6,
          "audio_hw_primary",
...
LABEL_92:
  ...
  if ( *(_DWORD *)(v117 + 168) == 2 )
    *(_DWORD *)(v117 + 200) = 4;
  sub_5730(v117);
  v77 = v3->sample_rate;
  if ( v77 != v3->in_sample_rate )
  {
    _android_log_print(
      3,
      "audio_hw_primary",
    ...
    if ( create_resampler(v3->in_sample_rate, v3->sample_rate, 2, 4) )
    {
      free(v3->v_200);
      goto LABEL_92;
    }
    (*(void (__cdecl **)(struct resampler_itfe **, struct resampler_itfe *))v3->resampler)(
      v3->resampler,
      *v3->resampler);
  }
  v9 = v115;
...
LABEL_102:
  pthread_mutex_unlock(v14);
  j_pcm_data_dump((int)"/sdcard/Android/log/audio_dump/audio_hw_out1.pcm", (int)v4, v119, (int)"audio.hw.pcm.dump");
  v86 = v3->in_format;
  if ( v86 != 1 && v3->format == AUDIO_FORMAT_DEFAULT )
  {
    v87 = 16;
    if ( v86 == 4 )
      v87 = 8;
    ...
    v9 >>= 1;
    v121 = (v119 >> 1) / v9;
    v120 = 4 * unk_11014 * dword_11010 / v9;
  }
  if ( v5->b_314 && v5->b_289 )
  {
    if ( v119 >> 1 )
    {
      v89 = 0;
      ...
      {
        v90 = 127 * v4[v89];
        *((_BYTE *)v5->v_79 + 4 * v89 + 1) = v90 >> 7;
        v91 = v90 >> 15;
        v92 = 2 * v90;
        *((_BYTE *)v5->v_79 + 4 * v89 + 2) = v91;
        v93 = (char *)v5->v_79 + 4 * v89;
        if ( (signed int)HIBYTE(v4[v89]) <= -1 )
          v93[3] = -1;
        else
          v93[3] = 0;
        *((_BYTE *)v5->v_79 + 4 * v89++) = v92;
      }
      while ( v119 >> 1 != v89 );
    }
    v9 *= 2;
  ...
  if ( v94 )
  {
    if ( v5->b_314 && v5->b_289 )
      v4 = v5->v_79;
    v95 = v3->v_200;
    ((void (__cdecl *)(struct resampler_itfe **, _WORD *))v94[2])(v94, v4);
    v4 = v3->v_200;
    v96 = v120;
  }
  else
  ...
  v97 = v3;
  v98 = v4;
  j_pcm_data_dump((int)"/sdcard/Android/log/audio_dump/audio_hw_out2.pcm", (int)v4, v96 * v9, (int)"audio.hw.pcm.dump");
  v99 = (int)&v97->pcm;
  v100 = 0;
  v101 = 0;
  do
  {
    v102 = *(_DWORD *)(v99 + 4 * v101);
    if ( v102 )
    {
      v100 = pcm_write(v102, v98);
      if ( v100 )
      {
        v103 = pcm_get_error(*(_DWORD *)(v99 + 4 * v101));
        _android_log_print(
          6,
          "audio_hw_primary",
          "%s: ret=%d, card_device = %d, error=%s",
          "out_write",
          v100,
          v101,
          v103);
...
LABEL_134:
        ...
        v100 = 0;
        *(_QWORD *)&v97->v_208 += v119 / ((unsigned int)v97->v_116 * v105);
      }
    }
    ++v101;
  }
  ...
  {
LABEL_141:
    v106 = ((int (__fastcall *)(stream_out *))v3->stream.common.get_format)(v3);
    v107 = (v106 & 0xFF000000) == 218103808;
    if ( (v106 & 0xFF000000) != 218103808 )
      v107 = (v106 & 0xFF000000) == 0;
    if ( !v107 )
    {
      v109 = 1;
LABEL_159:
      usleep(1000000 * v119 / (v3->in_sample_rate * v109));
      goto LABEL_160;
    }
    switch ( v106 )
    {
...
LABEL_148:
    ...
    v110 = ((int (__fastcall *)(_DWORD))v3->stream.common.get_channels)(v3);
    if ( 2 == v110 >> 30 )
    {
      v111 = v110 & 0x3FFFFFFF;
    }
    else
    {
      if ( v110 >> 30 )
    ...
    v112 = ((v111 - ((v111 >> 1) & 0x55555555)) & 0x33333333)
         + (((v111 - ((v111 >> 1) & 0x55555555)) >> 2) & 0x33333333);
    v113 = 16843009 * ((v112 + (v112 >> 4)) & 0xF0F0F0F) >> 24;
LABEL_158:
    v109 = v113 * v108;
    goto LABEL_159;
  }
LABEL_160:
  if ( _stack_chk_guard != v132 )
    _stack_chk_fail(_stack_chk_guard - v132, v132);
  return v119;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_9:
  ...
  if ( _stack_chk_guard != v10 )
    _stack_chk_fail(_stack_chk_guard - v10, v10);
  return v7;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
int __fastcall sub_7F90(int a1, int a2, int a3)
{
  ...
  unsigned int v36; // r0@57
  void *v37; // r0@60
  int v38; // r0@61
  int v39; // r0@67
  int v40; // r1@69
  signed int *v41; // r4@70
  signed int v42; // r7@70
  unsigned int v43; // r0@71
  int (__fastcall **v44)(_DWORD, _DWORD, _DWORD); // r7@73
  int v45; // r4@73
  signed int v46; // r0@77
  const char *v47; // r1@77
  const char *v48; // r2@77
  int v49; // r0@80
  int v50; // r1@81
  ...
  int v60; // r0@114
  bool v61; // zf@114
  signed int v62; // r4@119
  int v63; // r6@121
  int v64; // r9@117
  int v65; // r3@123
  __int64 v66; // kr00_8@125
  __int64 v67; // r0@126
  int v68; // r7@126
  int v69; // r0@134
  signed int v70; // r0@137
  unsigned int v71; // r0@143
  unsigned int v72; // r0@145
  unsigned int v73; // r0@147
  unsigned int v74; // r0@147
  unsigned int v75; // r7@150
  int i; // r4@150
  int v77; // r0@152
  __int64 v78; // r0@154
  int v79; // r6@155
  unsigned int v80; // r1@162
  unsigned int v81; // r0@165
  unsigned int v82; // r1@168
  unsigned int v83; // r2@168
  int v84; // r6@169
  int v85; // r0@178
  bool v86; // zf@178
  signed int v87; // r6@183
  int v88; // r0@181
  unsigned int v89; // r0@189
  unsigned int v90; // r0@191
  unsigned int v91; // r0@193
  unsigned int v92; // r0@193
  int v94; // [sp+0h] [bp-60h]@0
  int v95; // [sp+4h] [bp-5Ch]@0
  int v96; // [sp+4h] [bp-5Ch]@125
  int v97; // [sp+14h] [bp-4Ch]@19
  __int64 newthread; // [sp+20h] [bp-40h]@150
  int v99; // [sp+28h] [bp-38h]@4
  int (__fastcall **v100)(_DWORD, _DWORD, _DWORD); // [sp+28h] [bp-38h]@91
  __int64 v101; // [sp+2Ch] [bp-34h]@154
  int v102; // [sp+34h] [bp-2Ch]@152
  int v103; // [sp+38h] [bp-28h]@1
...
LABEL_49:
  ...
  v33 = (*(int (__fastcall **)(int))(v3 + 12))(v3);
  if ( 2 == v33 >> 30 )
  {
    v34 = v33 & 0x3FFFFFFF;
  }
  ...
  v35 = ((v34 - ((v34 >> 1) & 0x55555555)) & 0x33333333) + (((v34 - ((v34 >> 1) & 0x55555555)) >> 2) & 0x33333333);
  v36 = 16843009 * ((v35 + (v35 >> 4)) & 0xF0F0F0F) >> 24;
LABEL_59:
  v30 = v36 * v29;
LABEL_60:
  v37 = malloc(v27 * v30);
  ...
  else
  {
    ...
    *(_DWORD *)(v17 + 200) = v40;
    if ( !v39 )
    {
      ...
      v69 = *(_DWORD *)(v3 + 160);
      *(_DWORD *)(v17 + 176) = v69;
      v41 = (signed int *)(v17 + 172);
      v42 = *(_DWORD *)(v17 + 172);
      if ( v69 == -2147483644 )
      {
        v70 = 2;
      }
      else if ( v69 == -2147483640 )
      {
        v70 = 32;
      }
      else
...
LABEL_71:
  sub_5730(v17);
  *v41 = v42;
  v43 = 100 * *(_DWORD *)(v3 + 128) / 0x3E8u;
  *(_DWORD *)(v3 + 168) = v43;
  *(_WORD *)(v3 + 166) = 0xFFFF / v43;
  *(_WORD *)(v3 + 164) = 0;
  *(_BYTE *)(v3 + 124) = 0;
LABEL_72:
  ...
  if ( !*(_DWORD *)(v3 + 72) )
  {
    v60 = (*(int (__fastcall **)(int))(v3 + 16))(v3);
    ...
    if ( !v61 )
    {
      v64 = 1;
LABEL_150:
      v75 = (unsigned int)v5 / v10;
      LODWORD(newthread) = v5;
      for ( i = 0; (signed int)v75 > i; i += v102 )
      {
        v102 = v75 - i;
        v77 = *(_DWORD *)(v3 + 132);
        if ( v77 )
        {
          (*(void (__cdecl **)(int, int))(v77 + 4))(v77, v99 + i * v64);
        }
        else
        {
          LODWORD(v78) = 0;
          HIDWORD(v78) = v75 - i;
          v101 = v78;
          sub_8BD4(v3 + 136, (int)&v101);
          if ( (_DWORD)v101 )
          {
            v79 = HIDWORD(v101);
            _aeabi_memcpy(v99 + i * v64, v101);
            v102 = v79;
          }
          else
          {
      ...
      if ( v80 )
      {
        ...
        if ( v75 )
        {
          ...
          do
          {
            ...
            LOWORD(v81) = v82 + v81;
            *(_WORD *)(v99 + 2 * v83) = (unsigned int)(v84 * *(_WORD *)(v99 + 2 * v83)) >> 16;
            ++v83;
          }
          while ( v83 < v75 );
          v80 = *(_DWORD *)(v3 + 168);
...
LABEL_139:
    ...
    v71 = (*(int (__fastcall **)(_DWORD))(v3 + 12))(v3);
    if ( 2 == v71 >> 30 )
    {
      v72 = v71 & 0x3FFFFFFF;
    }
...
LABEL_149:
  ...
  v44 = (int (__fastcall **)(_DWORD, _DWORD, _DWORD))(v16 + 320092);
  v45 = v99;
  while ( 1 )
  {
    *(_DWORD *)(v3 + 88) = v5;
    if ( !*(_DWORD *)(v3 + 84) )
    {
      ...
      {
        v46 = 6;
        v47 = "audio_hw_primary";
        v48 = "#### pcm_read_thread() thread creation failed ####";
      }
      else
      {
        *(_DWORD *)(v3 + 76) = 0;
        *(_DWORD *)(v3 + 84) = 1;
        v46 = 4;
        v47 = "audio_hw_primary";
        v48 = "#### Pcm read thread created successfully ####";
      }
      _android_log_print(v46, v47, v48);
    }
    v49 = *(_DWORD *)(v3 + 104);
    if ( v49
      && (v50 = *(_DWORD *)(v3 + 100)) != 0
      && v49 >= v50
      && v49 - v50 <= (unsigned int)v5
      && *(_DWORD *)(v16 + 4) )
    {
      if ( !*(_DWORD *)(v3 + 76) )
      {
...
LABEL_101:
    ...
    if ( v49 - *(_DWORD *)(v3 + 100) >= (unsigned int)v5 )
      goto LABEL_101;
    _android_log_print(2, "audio_hw_primary", "before slim read");
    v51 = *(_DWORD *)(v3 + 96);
    if ( *(_DWORD *)(v3 + 108) + (signed int)v5 >= v51 )
    {
    ...
    v52 = *(_DWORD *)(v3 + 104);
    v53 = *(_DWORD *)(v3 + 120);
    if ( v52 + (signed int)v5 <= v51 )
    {
      HIDWORD(v5) = v45;
      v54 = pcm_read(v53, *(_DWORD *)(v3 + 92) + v52, v5);
      v59 = 0;
      if ( !v54 )
        v59 = v5;
      *(_DWORD *)(v3 + 104) += v59;
    ...
    else
    {
      ...
      if ( !v54 )
        v57 = v5;
      v58 = v56 + v57 - *(_DWORD *)(v3 + 96);
      if ( v57 - v58 >= 1 )
        _aeabi_memcpy(v56 + *(_DWORD *)(v3 + 92), v55);
      *(_DWORD *)(v3 + 104) = 0;
      _aeabi_memcpy(*(_DWORD *)(v3 + 92), v55 + v57 - v58);
      *(_DWORD *)(v3 + 104) += v58;
      *(_DWORD *)(v3 + 108) += v57;
      v94 = v57;
...
LABEL_123:
      ...
      if ( v65 >= v63 )
      {
        _android_log_print(3, "audio_hw_primary", "hal read memcpy cvq %d", v63, v94, v95);
        v66 = *(_QWORD *)(v3 + 96);
        if ( HIDWORD(v66) + v63 <= (signed int)v66 )
        {
          _aeabi_memcpy(v45 + HIDWORD(v5), *(_DWORD *)(v3 + 92) + HIDWORD(v66));
          *(_DWORD *)(v3 + 100) += v63;
          *(_DWORD *)(v3 + 108) -= v63;
        }
        else
        {
          ...
          if ( v63 - v68 >= 1 )
            _aeabi_memcpy(v45 + HIDWORD(v5), HIDWORD(v67) + *(_DWORD *)(v3 + 92));
          _aeabi_memcpy(v45 + HIDWORD(v5) + v63 - v68, *(_DWORD *)(v3 + 92));
          *(_DWORD *)(v3 + 100) = v68;
          *(_DWORD *)(v3 + 108) -= v63;
          _android_log_print(
            3,
        ...
        _android_log_print(2, "audio_hw_primary", "read/write offset - %d/%d ", *(_QWORD *)(v3 + 100), v96);
      }
      else
      {
        _android_log_print(
...
LABEL_111:
  ...
  _android_log_print(2, "audio_hw_primary", "hal read strm end cvq %d", HIDWORD(v5), v94, v95);
  if ( *(_DWORD *)(v16 + 4) )
  {
    v63 = v5 - HIDWORD(v5);
    goto LABEL_123;
...
LABEL_131:
  HIDWORD(v5) = v3 + 116;
LABEL_173:
  if ( !v54 && *(_BYTE *)(v97 + 180) )
    _aeabi_memclr(v45, v5);
  j_pcm_data_dump((int)"/sdcard/Android/log/audio_dump/audio_hw_in.pcm", v45, v5, (int)"audio.hw.pcm.dump");
LABEL_177:
  if ( v54 <= -1 )
  {
LABEL_178:
    v85 = (*(int (__fastcall **)(_DWORD))(v3 + 16))(v3);
    v86 = (v85 & 0xFF000000) == 218103808;
    if ( (v85 & 0xFF000000) != 218103808 )
      v86 = (v85 & 0xFF000000) == 0;
    if ( !v86 )
    {
      v88 = 1;
      goto LABEL_196;
...
LABEL_185:
    ...
    v89 = (*(int (__fastcall **)(_DWORD))(v3 + 12))(v3);
    if ( 2 == v89 >> 30 )
    {
      v90 = v89 & 0x3FFFFFFF;
LABEL_193:
      v91 = ((v90 - ((v90 >> 1) & 0x55555555)) & 0x33333333) + (((v90 - ((v90 >> 1) & 0x55555555)) >> 2) & 0x33333333);
      v92 = 16843009 * ((v91 + (v91 >> 4)) & 0xF0F0F0F) >> 24;
    }
    else
    {
      if ( !(v89 >> 30) )
    ...
    v88 = v92 * v87;
LABEL_196:
    usleep(1000000 * (signed int)v5 / (unsigned int)(*(_DWORD *)(v3 + 128) * v88));
  }
  pthread_mutex_unlock((pthread_mutex_t *)HIDWORD(v5));
  if ( _stack_chk_guard != v103 )
    _stack_chk_fail(_stack_chk_guard - v103, v103);
  return v5;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_39:
  if ( _stack_chk_guard != v29 )
    _stack_chk_fail(_stack_chk_guard - v29, v29);
  return v4;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_39:
  ...
  if ( _stack_chk_guard != v45 )
    _stack_chk_fail(_stack_chk_guard - v45, v45);
  return v8;
}
// 2FD8: using guessed type int _android_log_print(_DWORD, _DWORD, const char *, ...);
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_56:
  if ( _stack_chk_guard != v39 )
    _stack_chk_fail(result, _stack_chk_guard - v39);
  return result;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
LABEL_24:
  if ( _stack_chk_guard != v24 )
    _stack_chk_fail(result, _stack_chk_guard - v24);
  return result;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
signed int __fastcall sub_A558(int a1, int a2)
{
  ...
  if ( _stack_chk_guard != v8 )
    _stack_chk_fail(result, _stack_chk_guard - v8);
  return result;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
signed int __fastcall sub_AEAC(int a1)
{
  ...
  if ( _stack_chk_guard != v7 )
    _stack_chk_fail(_stack_chk_guard - v7, v7);
  return v2;
}
// 2FE4: using guessed type int __fastcall _stack_chk_fail(_DWORD, _DWORD);
...
// ALL OK, 169 function(s) have been successfully decompiled
